 ...
 */
public class Logback13AppenderAccessor extends AbstractLogDestination {
   ...
   */
  public Logback13LoggerAccessor getLoggerAccessor() {
   ...
   */
  public void setLoggerAccessor(Logback13LoggerAccessor loggerAccessor) {
