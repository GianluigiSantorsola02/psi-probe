...
const Draggable = Class.create({
  initialize: function (element) {
    ...
    const options = Object.extend(defaults, arguments[1] || {});
  ...
  _getWindowScroll: function (w) {
    let T, L, W, H;
    if(w === w.document.documentElement || w === w.document.body) {
...
const Sortable = {
  ...
  destroy: function(element){
    element = $(element);
    let s = Sortable.sortables[element.id];
  ...
  create: function(element) {
    ...
    if(options.dropOnEmpty || options.tree) {
      this.addDroppable(element, options_for_tree);
    ...
    (options.elements || this.findElements(element, options) || []).each(function(e, i) {
      ...
      this.addDroppable(e, options_for_droppable);
  ...
  addDroppable: function(element, options) {
  ...
  mark: function(dropon, position) {
    ...
    let offsets = dropon.cumulativeOffset();
